...
parameter berupa angka. Function akan me-return nilai total dari digit 
 tersebut dengan menambahkan satu per satu angka dari digit paling 
...
function totalDigitRekursif(angka) {
  ...
  if (angkaStr.length == 1) {
    ...
    return Number(angkaStr[0])  +  totalDigitRekursif(Number(angka.toString().substring(1)))                                                                                                                                                                                                                     
  }
}
